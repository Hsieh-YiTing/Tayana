<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Tayana.BackStage.Register" MaintainScrollPositionOnPostback="True" %>
...
<head>
    ...
    <!-- color .css -->
    <link rel="stylesheet" type="text/css" href="mashable-lite/assets/css/color/color-1.css" id="color" />
</head>
<body>
                                ...
                                <form class="md-float-material">
                                    <div class="auth-box">
                                        ...
                                        <div class="input-group">
                                            <asp:TextBox ID="UserName" runat="server" CssClass="form-control" placeholder="Choose Username"></asp:TextBox>
                                            <%--<input type="text" class="form-control" placeholder="Choose Username">--%>
                                            <span class="md-line"></span>
                                        </div>
                                        <div class="input-group">
                                            <asp:TextBox ID="Password" runat="server" CssClass="form-control" placeholder="Choose Password" TextMode="Password"></asp:TextBox>
                                        ...
                                        <asp:Label ID="DefaultPremissions" runat="server" Text="3" Visible="False"></asp:Label>
                                        <div class="row m-t-30">
                                            <div style="display: flex; justify-content: center; align-items: center; gap: 20px; width: 100%;">
                                                <asp:Button ID="RegisterBtn" runat="server" Text="Sign up" CssClass="btn btn-info" OnClick="RegisterBtn_Click"/>
                                                <asp:Button ID="ReturnLogin" runat="server" Text="Cancel" CssClass="btn btn-info" OnClick="ReturnLogin_Click"/>
                                            </div>
                                        </div>
                                    </div>
                                </form>
